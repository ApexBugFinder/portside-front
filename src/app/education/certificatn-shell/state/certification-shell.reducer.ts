...
import {
  Certification,
  defaultCert,
} from "../../Models/certification/certification";
...
} from "./certification-shell.actions";
...
export function certificationReducer(
  ...
  switch (action.type) {
    ...
    case CertificationActionTypes.SET_CURRENT_CERTIFICATION_from_CERT_EFFECTS:
    case CertificationActionTypes.SET_CURRENT_CERTIFICATION_from_EDUCATION_CPT:
      return {
        ...state,
        id: action.payload.id,
        projectCreatorID: action.payload.projectCreatorID,
