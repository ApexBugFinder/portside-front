...
var experience_shell_actions_1 = require("./experience-shell.actions");
var initialState = {
...
function experienceReducer(state, action) {
    ...
    switch (action.type) {
        case experience_shell_actions_1.ExperienceActionTypes.SET_ORIGINALPROJECT:
        ...
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE:
            return __assign(__assign({}, state), { id: action.payload.id, projectCreatorID: action.payload.projectCreatorID, company: action.payload.company, title: action.payload.title, logoUrl: action.payload.logoUrl, started: action.payload.started, completed: action.payload.completed, city: action.payload.city, state: action.payload.state, roles: action.payload.roles });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_ID:
            return __assign(__assign({}, state), { id: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_PROJECTCREATOR_ID:
            return __assign(__assign({}, state), { projectCreatorID: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_COMPANY:
            return __assign(__assign({}, state), { company: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_TITLE:
            return __assign(__assign({}, state), { title: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_LOGO_URL:
            return __assign(__assign({}, state), { logoUrl: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_STARTED:
            return __assign(__assign({}, state), { started: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_COMPLETED:
            return __assign(__assign({}, state), { completed: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_CITY:
            return __assign(__assign({}, state), { city: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_STATE:
            return __assign(__assign({}, state), { state: action.payload });
        case experience_shell_actions_1.ExperienceActionTypes.SET_CURRENT_EXPERIENCE_ROLES:
            return __assign(__assign({}, state), { roles: action.payload });
        // CLEAR
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_ORIGINALPROJECT:
        ...
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE:
            return __assign(__assign({}, state), { id: initialState.id, projectCreatorID: initialState.projectCreatorID, company: initialState.company, title: initialState.title, logoUrl: initialState.logoUrl, started: initialState.started, completed: initialState.completed, city: initialState.city, state: initialState.state, roles: initialState.roles });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_ID:
            return __assign(__assign({}, state), { id: initialState.id });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_PROJECTCREATOR_ID:
            return __assign(__assign({}, state), { projectCreatorID: initialState.projectCreatorID });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_COMPANY:
            return __assign(__assign({}, state), { company: initialState.company });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_TITLE:
            return __assign(__assign({}, state), { title: initialState.title });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_LOGO_URL:
            return __assign(__assign({}, state), { logoUrl: initialState.logoUrl });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_STARTED:
            return __assign(__assign({}, state), { started: initialState.started });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_COMPLETED:
            return __assign(__assign({}, state), { completed: initialState.completed });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_CITY:
            return __assign(__assign({}, state), { city: initialState.city });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_STATE:
            return __assign(__assign({}, state), { state: initialState.state });
        case experience_shell_actions_1.ExperienceActionTypes.CLEAR_CURRENT_EXPERIENCE_ROLES:
            return __assign(__assign({}, state), { roles: initialState.roles });
        case experience_shell_actions_1.ExperienceActionTypes.RESET_CURRENT_EXPERIENCE:
        ...
        // TO DB
        // LOAD
        case experience_shell_actions_1.ExperienceActionTypes.LOAD_EXPERIENCES_FROM_DB_SUCCESS:
        ...
        case experience_shell_actions_1.ExperienceActionTypes.LOAD_EXPERIENCES_FROM_DB_FAIL:
            return __assign(__assign({}, state), { error: action.payload });
        // CREATE
        case experience_shell_actions_1.ExperienceActionTypes.SAVE_EXPERIENCE_TO_DB_SUCCESS:
            return __assign(__assign({}, state), { originalExperience: action.payload, id: action.payload.id, projectCreatorID: action.payload.projectCreatorID, company: action.payload.company, title: action.payload.title, logoUrl: action.payload.logoUrl, started: action.payload.started, completed: action.payload.completed, city: action.payload.city, state: action.payload.state, roles: action.payload.roles });
        case experience_shell_actions_1.ExperienceActionTypes.SAVE_EXPERIENCE_TO_DB_FAIL:
            return __assign(__assign({}, state), { error: action.payload });
        // UPDATE
        case experience_shell_actions_1.ExperienceActionTypes.UPDATE_EXPERIENCE_TO_DB_SUCCESS:
            return __assign(__assign({}, state), { originalExperience: action.payload, id: action.payload.id, projectCreatorID: action.payload.projectCreatorID, company: action.payload.company, title: action.payload.title, logoUrl: action.payload.logoUrl, started: action.payload.started, completed: action.payload.completed, city: action.payload.city, state: action.payload.state, roles: action.payload.roles });
        case experience_shell_actions_1.ExperienceActionTypes.UPDATE_EXPERIENCE_TO_DB_FAIL:
            return __assign(__assign({}, state), { error: action.payload });
        // DELETE
        case experience_shell_actions_1.ExperienceActionTypes.DELETE_EXPERIENCE_TO_DB_SUCCESS:
            return __assign(__assign({}, state), { originalExperience: action.payload, id: action.payload.id, projectCreatorID: action.payload.projectCreatorID, company: action.payload.company, title: action.payload.title, logoUrl: action.payload.logoUrl, started: action.payload.started, completed: action.payload.completed, city: action.payload.city, state: action.payload.state, roles: action.payload.roles });
        case experience_shell_actions_1.ExperienceActionTypes.DELETE_EXPERIENCE_TO_DB_FAIL:
            return __assign(__assign({}, state), { error: action.payload });
        default:
            return state;
    }
