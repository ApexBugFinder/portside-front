...
export class EditShellComponent implements OnInit {
  ...
  constructor(
    ...
    this.projectCreatorID$ = this.editProjectStore.pipe(
      select(fromEditProject.getEditProjectProjectCreatorID)
    );
    this.projectName$ = this.editProjectStore.pipe(
      select(fromEditProject.getEditProjectProjectName)
    );
    this.projectDescription$ = this.editProjectStore.pipe(
      select(fromEditProject.getEditProjectDescription)
    );
    this.projectBanner$ = this.editProjectStore.pipe(
      select(fromEditProject.getEditProjectBigBanner)
    );
  ...
  ngOnInit(): void {
    this.projectID$.subscribe({
      next: (value) => {
        ...
        this.editProjectStore.dispatch(
          new edipProjectActions.LoadEditProjectProjectRequirements(
            this.projectIDStore as string
          )
        );
        return value;
      },
      error: (err) =>
        console.log(
          "OOps sorry, error occured getting projectId from store in edit shell component: ",
          err
        ),
      complete: () =>
        console.log(
          "Completed getting projectID from ngrx store in edit shell component"
        ),
    });
    ...
    this.projectCreatorID$.subscribe({
      ...
      error: (err) =>
        console.log(
          "OOps sorry, error occured getting projectCreatorId from store in edit shell component: ",
          err
        ),
      complete: () =>
        console.log(
          "Completed getting projectCreatorID from ngrx store in edit shell component"
        ),
    });
    ...
    this.projectName$.subscribe({
      ...
      error: (err) =>
        console.log(
          "OOps sorry, error occured getting projectName from store in edit shell component: ",
          err
        ),
      complete: () =>
        console.log(
          "Completed getting projectName from ngrx store in edit shell component"
        ),
    });
    this.projectDescription$.subscribe({
      ...
      error: (err) =>
        console.log(
          "OOps sorry, error occured getting projectDescription from store in edit shell component: ",
          err
        ),
      complete: () =>
        console.log(
          "Completed getting projectDescription from ngrx store in edit shell component"
        ),
    });
    this.initControls();
    this.resetControls();
  ...
  monitorForControlChanges() {
    this.projectNameAbstractControl?.valueChanges
      .pipe(debounceTime(500), distinctUntilChanged())
      .subscribe({
        next: (value) =>
          this.editProjectStore.dispatch(
            new edipProjectActions.SetEditProjectProjectName(value)
          ),
        error: (err) =>
          console.log(
            "OOps, there was an error while changing the value of your projectName"
          ),
        complete: () =>
          console.log(
            "Completed: updating your Edit Project Project Name in the edit shell component"
          ),
      });
    this.descriptionAbstractControl?.valueChanges
      .pipe(debounceTime(500), distinctUntilChanged())
      .subscribe({
        next: (value) =>
          this.editProjectStore.dispatch(
            new edipProjectActions.SetEditProjectDescription(value)
          ),
        error: (err) =>
          console.log(
            "OOps, there was an error while changing the value of your projectDEscription in edit shell component"
          ),
        complete: () =>
          console.log(
            "Completed: updating your Edit Project Project Name in the edit shell component"
    ...
    this.bannerAbstractControl?.valueChanges.subscribe({
      ...
      error: (err) =>
        console.log(
          "OOOps, there was an error while changing the value of your banner url: ",
          err
        ),
    ...
    this.smallBannerAbstractControl?.valueChanges.subscribe({
      ...
      error: (err) =>
        console.log(
          "OOOps, there was an error while changing the value of your smallbanner url: ",
          err
        ),
  ...
  onIconClick(openMenu: boolean) {
    this.iconMenuOpen = openMenu;
  }
...
{
    this.editProjectStore.dispatch(
      new edipProjectActions.SetEditProjectBigBanner(returnUrl)
    );
